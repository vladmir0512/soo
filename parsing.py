...
session = vk_api.VkApi(token='32de109d32de109d32de109da732a5fc9a332de32de109d509a9e0a6df944a0566ceae3')
vk = session.get_api()
global j,i
myData = [["post_number","post_text", "first_name", "second_name","comment","city","country","education","occupation" ]]
text=""
name=''
lastname=''
           ...
           #     break
            ...
            for comment in comments["items"]:
                ...
                for post in posts:
                    global text
                    text=post['text']
                myData.append([j,text, name ,lastname, comment['text'],city,country,education,occupation])
                i = i+1
...
print ('Цикл завершен')
myFile = open('Regnum.csv', 'w', encoding='utf-16')
